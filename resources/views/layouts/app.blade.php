        ...
        <nav class="flex gap-6 items-center">
            @auth
                ...
                <a href="{{ route('dashboard', auth()->user()->username) }}"
                   class="font-bold text-gray-500 text-sm">{{ auth()->user()->username }}</a>
            ...
            @else
                ...
                <a href="{{ route('login') }}"
                   class="font-bold uppercase text-gray-600 text-sm">Login</a>
                <a href="{{ route('register') }}"
                   class="font-bold uppercase text-gray-600 text-sm">Register</a>
            @endauth
        </nav>
    </div>
</header>
